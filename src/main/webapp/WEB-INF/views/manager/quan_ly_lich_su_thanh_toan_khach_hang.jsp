...
<div class="container">
	<div class="row">
		<div style="margin-left: 0px;width:1300px" class="col-md-8 offset-md-2">
			<form action="/Tinhtiendien/quan_ly/quan_ly_lich_su_thanh_toan_khach_hang/tim_kiem" class="custom-form" method="GET">
			    <div class="row mb-3">
			        <div class="col">
	...
	%>
		<div style="display: flex; justify-content: center; margin-bottom: -30px;">
			...
			<form action="/Tinhtiendien/quan_ly/quan_ly_lich_su_thanh_toan_khach_hang" class="custom-form" id="submitPage" method="GET">
