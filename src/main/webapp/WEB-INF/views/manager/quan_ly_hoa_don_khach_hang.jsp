...
<div class="container">
	<div class="row">
		<div style="margin-left: 0px;width:1300px" class="col-md-8 offset-md-2">
			<form action="/Tinhtiendien/quan_ly/quan_ly_hoa_don_khach_hang/tim_kiem" class="custom-form" method="GET">
			    <div class="row mb-3">
			        <div class="col">
...
<!-- 			        </div> -->
	...
	%>
		<div style="display: flex; justify-content: center; margin-bottom: -30px;">
			...
			<form action="/Tinhtiendien/quan_ly/quan_ly_hoa_don_khach_hang" class="custom-form" id="submitPage" method="GET">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Add employee form -->
                        <form action = "/Tinhtiendien/quan_ly/quan_ly_hoa_don_khach_hang/them" method="POST" id ="addCustomer">
                            <div class="mb-3">
        ...
        <div class="modal fade" id="editEmployeeModal" tabindex="-1" aria-labelledby="editEmployeeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Edit employee form -->
                        <form action = "/Tinhtiendien/quan_ly/quan_ly_hoa_don_khach_hang/sua" method="POST" id ="editCustomer">
                        	<div class="mb-3">
                        		<div class="container">
                        		  <div class="row">
								  	<div class="col">
       	...
       	<div class="modal fade" id="deleteEmployeeModal" tabindex="-1" aria-labelledby="deleteEmployeeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                        <form id="formToDelete" action="/Tinhtiendien/quan_ly/quan_ly_hoa_don_khach_hang/xoa" method="POST">
