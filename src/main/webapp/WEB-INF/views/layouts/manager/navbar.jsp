        ...
        <li class="nav-item">
          ...
          <ul class="dropdown-menu" id="userDropdown">
            <li>
              ...
              <div class="info">${info_quanly.hovaten}</div>
            </li>

            <li>
              <a class="dropdown-item" href="#">Mã quản lý</a>
              <div class="info">${info_quanly.nhanvien_id}</div>
            </li>
            <li>
              <a class="dropdown-item" href="#">Email</a>
              <div class="info">${info_quanly.email}</div>
            </li>
            <li>
              <a class="dropdown-item" href="#">Số điện thoại</a>
              <div class="info">${info_quanly.sdt}</div>
            </li>
