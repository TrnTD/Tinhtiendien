...
<div class="sidebar" style="overflow-y: auto; height: 100vh;">
    ...
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link menu-item" href="/Tinhtiendien/nhan_vien/quan_ly_chung"><i class="fa-solid fa-chart-simple"></i> Quản lý chung</a>
        </li>
        <li class="nav-item">
...
<!--       </li> -->
      ...
      <li class="nav-item">
        <a class="nav-link menu-item" href="/Tinhtiendien/nhan_vien/quan_ly_tai_khoan"><i class="fa-solid fa-id-badge"></i> Quản lý tài khoản</a>
      </li>
    </ul>
</div>
</body>
